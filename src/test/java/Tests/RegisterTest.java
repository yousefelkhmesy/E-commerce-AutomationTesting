...
public class RegisterTest extends TestBase {
    ...
    public void EnterValidDataForRegistertion() {
        ...
        registerPage.typeEmail("FakeAccTesting001@gmail.com");
        ...
        Assert.assertEquals(successPage.getHeaderText(), "Your Account Has Been Created!");
        Assert.assertTrue(successPage.getParagraphText().contains("Congratulations!"));
        Assert.assertTrue(successPage.getCurrentUrl().contains("account/success"));
